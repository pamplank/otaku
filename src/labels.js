...
export function hotspotDefs() {
  ...
  return [
    ...
    { id: 'logo', pos: [LG.width / 2 + 0.3, L.logoY - 0.4, L.logoZ], title: 'OPF logo sign',
      lines: ['Die-cut board on the front truss', `≈ ${LG.width} m wide (est.)`, 'Official CyberE logo only, as supplied'] },
